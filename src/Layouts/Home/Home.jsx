                      ...
                      <section className="font-Poppins">
                        <div className=" hero shadow-2xl px-5 to-base-200 w-[80%] mx-auto mt-16 rounded-lg flex items-center gap-5 lg:h-[400px]">
                          <div className="">
                            ...
                            <p className="py-6">
                              At XYZ, our mission is to provide businesses with
                              a powerful and intuitive tool that streamlines
                              asset management processes, enhances productivity,
                              and reduces administrative overhead. We aim to
                              deliver a seamless experience that helps companies
                              keep track of their valuable resources and ensure
                              they are being used effectively and responsibly.
                            </p>
                          </div>
                            ...
                            <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                              <div>
                                ...
                                <p className="mt-3 text-lg ">
                                  ...
                                  tailored to meet the needs of businesses of
                                  all sizes. Here’s what you can expect
                                </p>
                                <div className="mt-12 space-y-12">
                                  <div className="flex">
                                    ...
                                    <div className="ml-4">
                                      ...
                                      <p className="mt-2 text-black">
                                        ...
                                        for HR Managers and other users to
                                        navigate and manage assets without
                                        extensive training.
                                      </p>
                                    </div>
                                  </div>
                                  <div className="flex">
                                    ...
                                    <div className="ml-4">
                                      ...
                                      <p className="mt-2 text-black">
                                        Easily track and manage both returnable
                                        and non-returnable assets. Know exactly
                                        where each item is, who is using it, and
                                        when it is due for return or
                                        replacement.
                                      </p>
                                    </div>
                                  </div>
                                  <div className="flex">
                                    ...
                                    <div className="ml-4">
                                      ...
                                      <p className="mt-2 text-black">
                                        ...
                                        analyze asset usage patterns, identify
                                        potential issues, and make informed
                                        decisions.
                                      </p>
                                    </div>
                                  </div>
                                ...
                                <div className="mt-12 space-y-12">
                                  ...
                                  <div className="flex">
                                    ...
                                    <div className="ml-4">
                                      ...
                                      <p className="mt-2 text-black">
                                        Get real-time updates on asset status
                                        and availability, ensuring that your
                              ...
                              <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                                <div className="lg:col-start-2">
                                  ...
                                  <p className="mt-3 text-lg text-black">
                                    Set up alerts and notifications for asset
                                    check-ins, check-outs, and maintenance
                                    schedules to keep everything running
                                    smoothly.
                                  </p>
                                  <div className="mt-12 space-y-12">
                                    <div className="flex">
                                      ...
                                      <div className="ml-4">
                                        ...
                                        <p className="mt-2 text-black">
                                          ...
                                          data with robust measures to protect
